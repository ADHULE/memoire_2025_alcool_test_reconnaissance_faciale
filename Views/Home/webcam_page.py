...
class ACCER_WEBCAMERA(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setMinimumSize(400, 200)  # Interface responsive
    ...
    def setup_ui(self):
        ...
        self.webcam_label.setScaledContents(
            False
        )  # Désactivé pour éviter les distorsions
        ...
        btn_layout.addStretch()
        btn_layout.addWidget(self.create_button("MainWindow", self.back_to_login_main_window))
        btn_layout.addStretch()
        ...
        self.load_stylesheet(
            "Styles/webcam_style.css"
        )  # Vérifiez que le fichier est au bon emplacement
